...
![image](https://github.com/user-attachments/assets/2698a0a0-779b-4056-b4dd-62d039bdc1ea)

```javascript copy filename="custom.js"
/************************************
 **            Markdown            **
 ************************************/
...
initMarkdown([
  {
    selector: ".information-widget-greeting span",
    linkify: false,
    html: false,
  },
...
/* Formatting for markdown blocks, since default element formating has been removed. */
.markdown-wrapper {
...
```yaml copy filename="widgets.yaml"
- greeting:
    text_size: xs
    text: |-
      # redacted.net
...
```yaml copy filename="services.yaml"
- Ad Guard Home:
    href: https://adguard.hairball.redacted.net/
    icon: https://cdn.jsdelivr.net/gh/selfhst/icons/svg/adguard-home.svg
    description: |-
      ![instance badge](https://img.shields.io/badge/primary-purple?style=flat)Network-wide Ad Blocking (DNS)

      https://adguard.hairball.redacted.net
