...
This adds markdown support for Service Descriptions and Greeting Widgets. You can add other sections by editing the parameters sent to `applyMarkdown()` in the MAIN section.
